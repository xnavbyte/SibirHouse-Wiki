...
[Скачать Launcher SibirHouse.exe](https://files.sibihouse.ru/Launcher SibirHouse.exe)


Скачай файл **Launcher SibirHouse.jar** (Linux/Windows, всё где есть Java):

[Скачать Launcher SibirHouse.jar](https://files.sibihouse.ru/Launcher SibirHouse.jar)

> VirusTotal проверил данные файлы!
...
![Окно входа в GravitLauncher](game/join.png)
...
![Главное меню лаунчера](game/mainm.png)

1. Выбери нужный сервер (Vanilla).

![Главное меню лаунчера](game/mainplay.png)
